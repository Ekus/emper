...
(function ($, window) {
    ...
    $.extend(signalR, {
        chat: {
            _: {
                hubName: 'Chat',
                ignoreMembers: ['mediaPlayerRegister', 'disconnect', 'getAlbums', 'playAlbum', 'playSong', 'pause', 'getState', 'namespace', 'ignoreMembers', 'callbacks'],
                connection: function () { return signalR.hub; }
            },

            mediaPlayerRegister: function (callback) {
                return serverCall(this, "MediaPlayerRegister", $.makeArray(arguments));
            },
            ...
            getAlbums: function (callback) {
                return serverCall(this, "GetAlbums", $.makeArray(arguments));
            },

            playAlbum: function (albumTitle, callback) {
                return serverCall(this, "PlayAlbum", $.makeArray(arguments));
            },

            playSong: function (albumTitle, songTitle, callback) {
                return serverCall(this, "PlaySong", $.makeArray(arguments));
            },

            pause: function (callback) {
                return serverCall(this, "Pause", $.makeArray(arguments));
            },

            getState: function (callback) {
                return serverCall(this, "GetState", $.makeArray(arguments));
            }
        }
    });
